...
```{r}
#サポートライン
abline(h=66971, col="#04c1c9", lwd=1.5)
abline(h=19345, col="#04c1c9", lwd=1.5)
#abline(h=3313, col="#04c1c9", lwd=1.5)
abline(h=1237, col="#04c1c9", lwd=1.5)
abline(h=230, col="#04c1c9", lwd=1.5)
abline(h=29, col="#04c1c9", lwd=1.5)

legend(14813+400, 66971*1.5, "66971", cex=0.75, text.col = "#04c1c9", box.col="white", bg="white", adj = 0.2, y.intersp=0)
legend(14813+400, 19345*1.5, "19345", cex=0.75, text.col = "#04c1c9", box.col="white", bg="white", adj = 0.2, y.intersp=0)
legend(14813+400, 1237*1.5, "1237", cex=0.75, text.col = "#04c1c9", box.col="white", bg="white", adj = 0.3, y.intersp=0)
legend(14813+400, 230*1.5, "230", cex=0.75, text.col = "#04c1c9", box.col="white", bg="white", adj = 0.3, y.intersp=0)
legend(14813+400, 29*1.5, "29", cex=0.75, text.col = "#04c1c9", box.col="white", bg="white", adj = 0.5, y.intersp=0)

#Y軸作成
lab <- c(c(1,3,6,10) %o% 10^(-1:4)); lab <- lab[-c(1,length(lab))]
axis(2, at = lab, labels = FALSE)
text(par("usr")[1]*0.998, lab, labels = lab, srt = 0, pos = 2, xpd = TRUE, cex=0.75)

mtext("BTC-USD", side = 2, line=3, cex=1.25)
...
lab <- seq.Date(min(Dat$Date), max(Dat$Date)+30, length.out =5, format="%Y年%B")
axis.Date(1, at=lab, labels = FALSE)
text(lab, par("usr")[3] - abs(par("usr")[1]-par("usr")[3])*0.4, labels = lab, srt = 45, pos = 1, xpd = TRUE, cex=0.9)

#mtext("© 2022 京橋のバイオインフォマティシャンの日常 by skume", side = 1, line=3.8, cex=0.7)
text(x = 16800, y = 30000, pos=4,
     labels= "Kyobashi", cex=1.5, col="#80808050", family="Helvetica-Bold")
text(x = 16800, y = 24000, pos=4,
     labels= "Bioinformatician", cex=1.5, col="#80808050", family="Helvetica-Bold")
text(x = 16800, y = 19000, pos=4,
     labels= "Daily Life by skume", cex=1.5, col="#00FF3F50", family="Helvetica-Bold")
```
...
head(BTC)
BTC02 <- BTC01
rownames(BTC02) <- BTC01$Date
BTC03 <- xts::as.xts(BTC02)
str(BTC03)
...
BTC03[,2] %>%
  ...
  htmltools::save_html(file="BTC_01.html")
